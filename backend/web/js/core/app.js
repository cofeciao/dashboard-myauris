...
(function(window, document, $) {
    ...
    $(window).on('load',function(){
        var rtl;
        var compactMenu = typeof menuIcon !== 'undefined' ? menuIcon : false; // Set it to true, if you want default menu to be compact
        if([true, false].indexOf(compactMenu) === -1) compactMenu = false;
        ...
        /*console.log('app compactMenu', compactMenu);*/
