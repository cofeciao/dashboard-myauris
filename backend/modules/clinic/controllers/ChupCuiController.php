...
/**
 * ChupCuiController implements the CRUD actions for PhongKhamChupCui model.
 */
class ChupCuiController extends HinhCustomer
{
    const FOLDER = 'chup-cui';
    ...
    public function actionUpload($id)
    {
        ...
        if (count($listFile) <= 0) {
            ...
            $rowChupHinh = PhongKhamChupCui::find()->where(['customer_id' => $id])->all();
            if ($rowChupHinh != null) {
