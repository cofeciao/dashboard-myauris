...
use backend\modules\clinic\models\search\PhongKhamLoaiThanhToanSearch;
...
/**
 * ClinicLoaiThanhToanController implements the CRUD actions for PhongKhamLoaiThanhToan model.
 */
class ClinicLoaiThanhToanController extends MyController
{
    ...
    {
        $searchModel = new PhongKhamLoaiThanhToanSearch();
    ...
    public function actionCreate()
    {
        if (Yii::$app->request->isAjax) {
            $model = new PhongKhamLoaiThanhToan();
    ...
    /**
     * Updates an existing PhongKhamLoaiThanhToan model.
    ...
    {
        if (($model = PhongKhamLoaiThanhToan::findOne($id)) !== null) {
            return $model;
        }
