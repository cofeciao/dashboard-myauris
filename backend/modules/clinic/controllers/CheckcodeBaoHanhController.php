...
use backend\modules\clinic\models\search\CheckcodeBaoHanhSearch;
...
/**
 * CheckcodeBaoHanhController implements the CRUD actions for CheckcodeBaoHanh model.
 */
class CheckcodeBaoHanhController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new CheckcodeBaoHanhSearch();
    ...
    /**
     * Updates an existing CheckcodeBaoHanh model.
    ...
    {
        if (($model = CheckcodeBaoHanh::findOne($id)) !== null) {
            return $model;
        }
