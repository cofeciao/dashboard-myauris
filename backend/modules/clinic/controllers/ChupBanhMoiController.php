...
/**
 * ChupBanhMoiController implements the CRUD actions for PhongKhamChupBanhMoi model.
 */
class ChupBanhMoiController extends HinhCustomer
{
    const FOLDER = 'chup-banh-moi';
    ...
    public function actionUpload($id)
    {
        ...
        if (count($listFile) <= 0) {
            ...
            $rowChupHinh = PhongKhamChupBanhMoi::find()->where(['customer_id' => $id])->all();
            if ($rowChupHinh != null) {
