...
use backend\modules\clinic\models\search\SearchDonHangBaoHanh;
...
/**
 * BaoHanhController implements the CRUD actions for DonHangBaoHanh model.
 */
class BaoHanhController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new SearchDonHangBaoHanh();
    ...
    /**
     * Updates an existing DonHangBaoHanh model.
    ...
    {
        if (($model = DonHangBaoHanh::findOne($id)) !== null) {
            return $model;
        }
