...
use backend\modules\clinic\models\form\FormDentalForm;
...
/**
 * DentalFormController implements the CRUD actions for PhongKhamDentalForm model.
 */
class DentalFormController extends HinhCustomer
{
    const FOLDER = 'dental-form';
    ...
    public function actionUpload($id)
    {
        ...
        if (count($listFile) <= 0) {
            ...
            $rowChupHinh = PhongKhamDentalForm::find()->where(['customer_id' => $id])->all();
            if ($rowChupHinh != null) {
