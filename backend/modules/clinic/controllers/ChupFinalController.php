...
/**
 * ChupFinalController implements the CRUD actions for PhongKhamChupFinal model.
 */
class ChupFinalController extends HinhCustomer
{
    const FOLDER = 'chup-ket-thuc';
    ...
    public function actionUpload($id)
    {
        ...
        if (count($listFile) <= 0) {
            ...
            $rowChupHinh = PhongKhamChupFinal::find()->where(['customer_id' => $id])->all();
            if ($rowChupHinh != null) {
