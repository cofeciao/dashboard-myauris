...
use backend\modules\clinic\models\form\FormUomRang2;
...
class UomRang2Controller extends HinhCustomer
{
    const FOLDER = 'uom_rang_2';
    ...
    public function actionUpload($id)
    {
        ...
        if (count($listFile) <= 0) {
            ...
            $rowChupHinh = PhongKhamUomRang2::find()->where(['customer_id' => $id])->all();
            if ($rowChupHinh != null) {
