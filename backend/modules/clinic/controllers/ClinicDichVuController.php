...
use backend\modules\clinic\models\search\PhongKhamDichVuSearch;
...
/**
 * ClinicDichVuController implements the CRUD actions for PhongKhamDichVu model.
 */
class ClinicDichVuController extends MyController
{
    ...
    {
        $searchModel = new PhongKhamDichVuSearch();
    ...
    /**
     * Updates an existing PhongKhamDichVu model.
    ...
    {
        if (($model = PhongKhamDichVu::findOne($id)) !== null) {
            return $model;
        }
