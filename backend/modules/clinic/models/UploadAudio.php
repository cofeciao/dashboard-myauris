...
/**
 * This is the model class for table "upload_audio".
 *
 * @property int $id
 ...
 */
class UploadAudio extends \yii\db\ActiveRecord
{
    public $fileImage;

    const FOLDER = 'upload-audio';
    ...
    public static function exitCustomer($customer_id)
    {
        return self::find()->where(['customer_id' => $customer_id])->exists();
    }
}
