...
/* @var $searchModel backend\modules\clinic\models\search\PhongKhamChupBanhMoiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Chụp banh môi');
            ...
            <div class="card">
                <div class="card-content collapse show ">
                    <div class="card-body card-dashboard">
                        <?php Pjax::begin(['id' => 'clinic-chup-banh-moi', 'timeout' => false, 'enablePushState' => true, 'clientOptions' => ['method' => 'GET']]); ?>
...
clinic.init({
    pjaxId: '#clinic-chup-banh-moi',
    urlChangePageSize: '$urlChangePageSize'
})
$(document).ready(function() {
    $('body').on('click', '.name-customer', function() {
        $('#clinic-chup-banh-moi').myLoading({
            msg: 'Đang tải hình',
            opacity: true,
        });
    });
