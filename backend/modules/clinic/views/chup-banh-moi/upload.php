...
$this->title = Yii::t('backend', 'Tải lên hình khách hàng banh môi');
...
function uploadImages(input){
    ...
    Object.keys(input.files).forEach(function(k){
        ...
        form_data.append('FormChupBanhMoi[id]', $('#dpz-multiple-files #customer').val());
        form_data.append('FormChupBanhMoi[fileImage][]', v);
        $.ajax({
            type: 'post',
            url: '$urlUploadImage',
            data: form_data,
