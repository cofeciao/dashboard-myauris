...
$cls_col_1 = 'col-xxl-5 col-xl-4 col-sm-6 col-12';
$cls_search_date_range = 'hidden';
$cls_search_code = 'hidden';
if ($model->type_search_date == 'range') {
    $cls_col_1 = 'col-xxl-5 col-xl-4 col-sm-6 col-12 search-by-range';
                ...
                <div class="form-group form-content row ml-0 mr-0">
                    ...
                    <div class="f-content">
                        <div class="search-code">
                            <?= $form->field($model, 'full_name', ['template' => '<div class="input-group">{input}<span class="input-group-addon1 clear-value"><span class="fa fa-times"></span></span></div>'])->textInput(['placeholder' => "Họ và tên, số điện thoại hoặc mã khách hàng"])->label(false) ?>
                        </div>
                    </div>
                </div>
                <div class="form-group form-content row ml-0 mr-0">
...
$('.f-title').on('click', 'input', function(){
    ...
    if(name == 'type-search-date'){
        if(v == 'range'){
            input.closest('.form-search-col').removeClass('col-xxl-4 col-xl-4 col-sm-6 col-12').addClass('col-xxl-5 col-xl-4 col-sm-6 search-by-range');
        } else {
