...
/* @var $searchModel backend\modules\clinic\models\search\ListChupHinhSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', Yii::t('backend', 'List Chup Hinhs'));
...
$(document).ready(function () {
    ...
    $('body').on('click', '.confirm-color', function (e) {
    ...
    }).on('beforeSubmit', '#form-list-chup-hinh', function(e){
        e.preventDefault();
        var form = $(this),
        ...
        $.ajax({
            ...
            if(res.code === 200){
                ...
                $.when($.pjax.reload({'container': customPjax.options.pjaxId, 'url': window.location.href})).done(function() {
