...
$cls_col_1 = 'col-xl-4 col-md-6 col-12';
                ...
                <div class="form-group form-content row ml-0 mr-0">
                    ...
                    <div class="f-content">
                        <div class="search-code code-full_name <?= $model->type_search_code == 'full_name' ? '' : 'hidden' ?>">
                            <?= $form->field($model, 'full_name', ['template' => '<div class="input-group">{input}<span class="input-group-addon clear-value"><span class="fa fa-times"></span></span></div>'])->textInput(['placeholder' => "Họ và tên"])->label(false) ?>
                        </div>
                        <div class="search-code code-code <?= $model->type_search_code == 'code' ? '' : 'hidden' ?>">
                            <?= $form->field($model, 'customer_code', ['template' => '<div class="input-group">{input}<span class="input-group-addon clear-value"><span class="fa fa-times"></span></span></div>'])->textInput(['placeholder' => "Mã khách hàng"])->label(false) ?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-search-col col-xl-4 col-md-6 col-12">
                <div class="form-group form-content row ml-0 mr-0">
                    ...
                    <div class="f-content">
                        ...
                        <div class="search-date appointment_time_to date-range <?= $cls_search_date_range ?>">
...
$('#form-search-clinic').on('change', 'input', function(){
