...
/* @var $searchModel backend\modules\clinic\models\search\PhongKhamChupFinalSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Chụp hình kết thúc');
            ...
            <div class="card">
                <div class="card-content collapse show ">
                    <div class="card-body card-dashboard">
                        <?php Pjax::begin(['id' => 'clinic-chup-final', 'timeout' => false, 'enablePushState' => true, 'clientOptions' => ['method' => 'GET']]); ?>
...
clinic.init({
    pjaxId: '#clinic-chup-final',
    urlChangePageSize: '$urlChangePageSize'
})

$(document).ready(function () {
    $('body').on('click', '.name-customer', function() {
        $('#clinic-chup-final').myLoading({
            msg: 'Đang tải hình',
            opacity: true,
        });
    });
