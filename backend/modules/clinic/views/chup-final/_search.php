...
if (Yii::$app->user->identity->permission_coso != null && $model->co_so == null && $roleUser == \common\models\User::USER_CHUP_HINH) {
    $model->co_so = Yii::$app->user->identity->permission_coso;
}

$cls_col_1 = 'col-xl-4 col-sm-6 col-12';
