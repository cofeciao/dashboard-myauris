...
/* @var $searchModel backend\modules\clinic\models\search\PhongKhamChupCuiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Chụp cùi');
                ...
                <div class="card">
                    <div class="card-content collapse show ">
                        <div class="card-body card-dashboard">
                            <?php Pjax::begin(['id' => 'clinic-chup-cui', 'timeout' => false, 'enablePushState' => true, 'clientOptions' => ['method' => 'GET']]); ?>
...
clinic.init({
    pjaxId: '#clinic-chup-cui',
    urlChangePageSize: '$urlChangePageSize'
})
$(document).ready(function() {
    $('body').on('click', '.name-customer', function() {
        $('#clinic-chup-cui').myLoading({
            msg: 'Đang tải hình',
            opacity: true,
        });
    });
