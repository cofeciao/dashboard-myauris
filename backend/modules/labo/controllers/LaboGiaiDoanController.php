...
/**
 * LaboGiaiDoanController implements the CRUD actions for LaboGiaiDoan model.
 */
class LaboGiaiDoanController extends MyController
{
    ...
    /**
     * Updates an existing LaboGiaiDoan model.
