...
$this->title = Yii::t('backend', 'Quản lý công đoạn');
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <div class="btn-add-campaign clearfix" style="margin-top:0px;position:relative">
                            <?= Html::a('<i class="fa fa-file-text-o"> Phiếu Labo</i>', ['/labo/labo-don-hang/view', 'id' => $labo_don_hang_id], ['title' => 'Phiếu Labo', 'data-pjax' => 0, 'class' => 'btn btn-default pull-left']) ?>

                            <?= Html::a('<i class="fa fa-plus"> Thêm công đoạn</i>', ['create-giai-doan', 'labo_don_hang_id' => $labo_don_hang_id], ['title' => 'Thêm công đoạn', 'data-pjax' => 0, 'class' => 'btn btn-default pull-left']) ?>
                        </div>
                            ...
                            <?= MyGridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'header' => '#',
                                        'template' => '<div class="btn-group" role="group">{update-giai-doan} </div>',
                                        'buttons' => [
