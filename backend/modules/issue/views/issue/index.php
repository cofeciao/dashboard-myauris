...
/* @var $searchModel backend\modules\issue\models\search\IssueSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', Yii::t('backend', 'Issues'));
                            ...
                            <?= MyGridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            /*$user = new backend\modules\issue\models\Issue();*/
