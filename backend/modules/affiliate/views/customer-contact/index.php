...
/* @var $searchModel backend\modules\affiliate\models\search\CustomerContactSearch */
                            ...
                            <?= MyGridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\affiliate\models\AffiliateCustomerContact();
...
<?php
$url = \yii\helpers\Url::toRoute(['/affiliate/customer-contact/show-hide']);
$urlDelete = \yii\helpers\Url::toRoute(['/affiliate/customer-contact/delete']);
$urlChangePageSize = \yii\helpers\Url::toRoute(['/affiliate/customer-contact/perpage']);
