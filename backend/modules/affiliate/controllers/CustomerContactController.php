...
use backend\modules\affiliate\models\search\CustomerContactSearch;
...
/**
 * CustomerContactController implements the CRUD actions for AffiliateCustomerContact model.
 */
class CustomerContactController extends MyController
{
    ...
    {
        if (($model = AffiliateCustomerContact::findOne($id)) !== null) {
            return $model;
        }
