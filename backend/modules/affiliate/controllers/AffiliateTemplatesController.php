...
use Yii;
use backend\modules\affiliate\models\AffiliateTemplates;
use backend\modules\affiliate\models\search\AffiliateTemplatesSearch;
...
/**
 * AffiliateTemplatesController implements the CRUD actions for AffiliateTemplates model.
 */
class AffiliateTemplatesController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new AffiliateTemplatesSearch();
    ...
    /**
     * Updates an existing AffiliateTemplates model.
    ...
    {
        if (($model = AffiliateTemplates::findOne($id)) !== null) {
            return $model;
        }
