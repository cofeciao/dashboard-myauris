...
use backend\modules\testab\models\search\AbAddKythuatSearch;
...
/**
 * KyThuatController implements the CRUD actions for AbAddKythuat model.
 */
class KyThuatController extends MyController
{
    ...
    {
        $searchModel = new AbAddKythuatSearch();
    ...
    /**
     * Updates an existing AbAddKythuat model.
    ...
    {
        if (($model = AbAddKythuat::findOne($id)) !== null) {
            return $model;
        }
