...
/* @var $searchModel backend\modules\testab\models\search\AbCampaignSearch */
...
<?php
$url = \yii\helpers\Url::toRoute(['/testab/campaign/show-hide']);
$urlDelete = \yii\helpers\Url::toRoute(['/testab/campaign/delete']);
