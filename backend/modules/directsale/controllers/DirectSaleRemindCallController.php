...
use backend\modules\directsale\models\search\DirectSaleRemindCallSearch;
...
/**
 * DirectSaleRemindCallController implements the CRUD actions for DirectSaleRemindCall model.
 */
class DirectSaleRemindCallController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new DirectSaleRemindCallSearch();
    ...
    {
        $model = new DirectSaleRemindCall();
    ...
    /**
     * Updates an existing DirectSaleRemindCall model.
    ...
    {
        if (($model = DirectSaleRemindCall::findOne($id)) !== null) {
            return $model;
        }
