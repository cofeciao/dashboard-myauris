...
$form = ActiveForm::begin([
    ...
    'action' => Url::toRoute(['order', 'id' => $customer->primaryKey]),
    'options' => [
...
//                                                $data = json_decode(json_encode($data), true);
                    ...
                    [
                        ...
                        'options' => function ($data) {
                            return [
                                ...
                                'class' => 'sl-sp san-pham-clinic select2 text-left',
                                'data-selected' => $data != null ? $data['san_pham'] : ''
                            ];
                        },
                        'headerOptions' => [
                            'width' => 190,
                    ...
                    [
                        ...
                        'defaultValue' => 1,
                        'value' => function ($data) {
                            return $data!= null && $data['so_luong'] != null ? $data['so_luong'] : 1;
                        },
                        'options' => [
                            'type' => 'number',
                    ...
                    [
                        ...
                        'options' => function ($data) {
                            return [
                                ...
                                'data-content' => $data != null ? $data['ly_do_chiet_khau'] : ''
                            ];
                        },
                        'headerOptions' => [
                            'width' => '150px',
