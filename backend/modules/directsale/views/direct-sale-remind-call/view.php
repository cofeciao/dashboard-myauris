...
$this->title = $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Direct Sale Remind Calls', 'url' => ['index']];
        ...
        <div class="col-12">
            ...
            'updated_by',
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                $user = new backend\modules\directsale\models\DirectSaleRemindCall();
