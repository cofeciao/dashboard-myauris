...
/* @var $searchModel backend\modules\appmyauris\models\SearchListChupFocusFace */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'List Chup Focus Faces');
                        ...
                        <div style="margin-top:5px;border:1px solid #ccc;border-radius:3px">
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getCatagoryID();
                                        },
                                        'filter' => ListChupFocusFace::getListCatagoryID(),
                                    ],
...
//                                    'value' => function ($model) {
//                                        /*$user = new backend\modules\appmyauris\models\ListChupFocusFace();*/
