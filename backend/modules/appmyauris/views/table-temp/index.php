...
/* @var $searchModel backend\modules\appmyauris\models\TableTempSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Table Temps');
                        ...
                        <div style="margin-top:5px;border:1px solid #ccc;border-radius:3px">
                            <?= MyGridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        'attribute' => 'id_tinh_trang_rang',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getTinhTrangRang();
                                        },
                                        'filter' => ArrayHelper::map(TinhTrangRang::getListTinhTrangRang(), 'id', 'name'),
                                        'headerOptions' => [
                                            'width' => 240,
                                        ],
                                    ],
                                    [
                                        'attribute' => 'id_do_tuoi',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getListDoTuoi();
                                        },
                                        'filter' => ArrayHelper::map(DoTuoi::getListDoTuoi(), 'id', 'name'),
                                        'headerOptions' => [
                                            'width' => 100,
                                        ],
                                    ],
                                    ...
                                    [
                                        'attribute' => 'nguoi_noi_tieng',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return \common\widgets\ModavaCheckbox::widget([
                                                'id' => $model->id,
                                                'value' => $model->nguoi_noi_tieng,
                                                'data' => json_encode([
                                                    'id' => $model->id,
                                                    'column' => 'nguoi_noi_tieng',
                                                ]),
                                                'className' => 'check-nguoi_noi_tieng'
                                            ]);
                                        },
                                    ],
                                    //                                [
                                    ...
                                    //                                    'value' => function ($model) {
                                    //                                        /*$user = new backend\modules\appmyauris\models\TableTemp();*/
...
$url_nguoi_noi_tieng  = \yii\helpers\Url::toRoute(['nguoi-noi-tieng']);
...
$(document).ready(function () {
    ...
    }).on('change', '.check-nguoi_noi_tieng', function () {
        var data = $(this).attr('data');
        $.ajax({
        type: "POST",
            data: {"data":data},
            url: "$url_nguoi_noi_tieng",
            dataType: "json",
