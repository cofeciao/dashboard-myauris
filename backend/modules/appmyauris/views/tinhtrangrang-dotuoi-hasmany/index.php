...
/* @var $searchModel backend\modules\appmyauris\models\TinhtrangrangDotuoiHasmanySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Tinhtrangrang Dotuoi Hasmanies');
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <div class="btn-add-campaign clearfix" style="margin-top:0px;position:relative">
                            ...
                            <br>
                            <h2>API : Tiến hành lấy ra danh sách tình trạng răng theo dộ tuổi</h2>
                        </div>
...
//                                        'value' => function ($model) {
//                                            /*$user = new backend\modules\appmyauris\models\TinhtrangrangDotuoiHasmany();*/
