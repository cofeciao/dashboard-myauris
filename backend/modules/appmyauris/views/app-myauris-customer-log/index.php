...
/* @var $searchModel backend\modules\appmyauris\models\AppMyaurisCustomerLogSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'App Myauris Customer Logs');
                        ...
                        <div style="margin-top:5px;border:1px solid #ccc;border-radius:3px">
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'header' => 'Actions',
                                        'template' => '<div class="btn-group" role="group">{update} {delete} {view}</div>',
                                        'buttons' => [
                                            ...
                                            'view' => function ($url, $model) {
                                                return Html::a(
                                                    ...
                                                    Url::toRoute(['view', 'id' => $model->primaryKey]),
                                                    [
