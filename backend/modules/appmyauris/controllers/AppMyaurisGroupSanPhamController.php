...
/**
 * AppMyaurisGroupSanPhamController implements the CRUD actions for AppMyaurisGroupSanPham model.
 */
class AppMyaurisGroupSanPhamController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new AppMyaurisGroupSanPhamSearch();
    ...
    {
        $model = new AppMyaurisGroupSanPham();
    ...
    /**
     * Updates an existing AppMyaurisGroupSanPham model.
    ...
    {
        if (($model = AppMyaurisGroupSanPham::findOne($id)) !== null) {
            return $model;
        }
