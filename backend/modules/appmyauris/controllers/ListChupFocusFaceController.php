...
use backend\modules\appmyauris\models\SearchListChupFocusFace;
...
/**
 * ListChupFocusFaceController implements the CRUD actions for ListChupFocusFace model.
 */
class ListChupFocusFaceController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new SearchListChupFocusFace();
    ...
    /**
     * Updates an existing ListChupFocusFace model.
    ...
    {
        if (($model = ListChupFocusFace::findOne($id)) !== null) {
            return $model;
        }
