...
use backend\modules\appmyauris\models\TinhtrangrangDotuoiHasmanySearch;
...
/**
 * TinhtrangrangDotuoiHasmanyController implements the CRUD actions for TinhtrangrangDotuoiHasmany model.
 */
class TinhtrangrangDotuoiHasmanyController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new TinhtrangrangDotuoiHasmanySearch();
    ...
    {
        $model = new TinhtrangrangDotuoiHasmany();
    ...
    /**
     * Updates an existing TinhtrangrangDotuoiHasmany model.
    ...
    {
        if (($model = TinhtrangrangDotuoiHasmany::findOne($id)) !== null) {
            return $model;
        }
