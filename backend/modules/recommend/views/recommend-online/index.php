...
/* @var $searchModel backend\modules\recommend\models\RecommendOnlineSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Recommend Onlines');
                        ...
                        <div style="margin-top:5px;border:1px solid #ccc;border-radius:3px">
                            <?= MyGridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        'attribute' => 'khach_quan_tam',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getKhachQuanTam();
                                        },
                                        'headerOptions' => [
                                            'width' => 250,
                                        ],
                                    ...
                                    //     'value' => function ($model) {
                                    //         /*$user = new backend\modules\recommend\models\RecommendOnline();*/
