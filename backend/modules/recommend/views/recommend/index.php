...
/* @var $searchModel backend\modules\recommend\models\SearchRecommend */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Recommends');
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <div class="btn-add-campaign clearfix" style="margin-top:0px;position:relative">
                            ...
                            <?=  Html::a('<i class="fa fa-plus"> Tư vấn</i>', ['demo'], ['title' => 'Thêm mới', 'data-pjax' => 0, 'class' => 'btn btn-default pull-left']) ?>
                        </div>
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'header' => 'Actions',
                                        'template' => '<div class="btn-group" role="group">{update} {delete} {copy}</div>',
                                        'buttons' => [
                                            ...
                                            'copy' => function ($url, $model) {
                                                return Html::a('<i class="fa fa-copy blue " ></i>', ['copy', 'id' => $model->id], ['class' => 'btn btn-default']);
                                            },
                                        ],
                                        'headerOptions' => [
                                            'width' => 100,
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $html = "<strong style='font-weight: 900;' >". $model->tieu_de ."</strong><br>". 
                                                    "<p style='font-size: 12px' >" .$model->getSanPham() ."</p>". 
                                                    "<i>".$model->mo_ta."</i>";
                                            return $html;
                                        },
                                        'headerOptions' => [
                                    ...
                                    [
                                        ...
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getPhanLoai();
                                        },
                                        'filter' => \backend\modules\recommend\models\Recommend::getListPhanLoai()
                                    ],
                                    ...
                                    [
                                        ...
                                        //'filter' => \backend\modules\recommend\models\Recommend::getListGioiTinh()
                                    ],
                                    [
                                        'attribute' => 'nhom_tuoi',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getNhomTuoi();
                                        },
                                        'headerOptions' => [
                                            'width' => 110,
                                        ],
                                        'filter' => \backend\modules\recommend\models\Recommend::getListNhomTuoi()
                                    ],
                                    [
                                        'attribute' => 'bo_cuc',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getBoCuc();
                                        },
                                        'headerOptions' => [
                                            'width' => 110,
                                        ],
                                        'filter' => \backend\modules\recommend\models\Recommend::getListBoCuc()
                                    ],
                                    [
                                        'attribute' => 'tinh_trang_rang',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getTinhTrangRang();
                                        },
                                        'contentOptions' => [
                                            'style' => 'font-size: 12px'
                                        ],
                                        'filter' => \backend\modules\recommend\models\Recommend::getListTinhTrangRang()
                                    ],
                                    [
                                        'attribute' => 'mong_muon',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getMongMuon();
                                        },
                                        'filter' => \backend\modules\recommend\models\Recommend::getListMongMuon(),
                                    ],
                                    [
                                        'attribute' => 'phong_cach',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return $model->getPhongCach();
                                        },
                                        'filter' => \backend\modules\recommend\models\Recommend::getListPhongCach()
                                    ],
                                    ...
                                    //     'format' => 'raw',
                                    //     'value' => function ($model) {
                                    //         return $model->getGiaiPhap();
                                    //     },
                                    //     'filter' => \backend\modules\recommend\models\Recommend::getListGiaiPhap()
                                    // ],
//                                    [
//                                        'attribute' => 'benh_ly',
//                                        'format' => 'raw',
//                                        'value' => function ($model) {
//                                            return $model->getBenhLy();
//                                        }
//                                    ],
...
//                                ],
                                ...
                                [
                                    ...
                                    'value' => function ($model) {
                                        /*$user = new backend\modules\recommend\models\Recommend();*/
