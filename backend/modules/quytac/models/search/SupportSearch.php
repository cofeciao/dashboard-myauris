...
namespace backend\modules\quytac\models\search;
...
/**
 * SupportSearch represents the model behind the search form of `backend\modules\quytac\models\Support`.
 */
class SupportSearch extends Support
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'slug', 'desription', 'content'], 'safe'],
        ];
    }
