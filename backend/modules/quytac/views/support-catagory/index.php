...
/* @var $searchModel backend\modules\quytac\models\search\SupportCatagorySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Danh mục hỗ trợ');
...
//                                'status',
                                ...
                                [
                                    ...
                                    'value' => function ($model) {
                                        $user = new backend\modules\quytac\models\SupportCatagory();
