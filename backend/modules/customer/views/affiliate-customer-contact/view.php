...
/* @var $model backend\modules\customer\models\AffiliateCustomerContact */

$this->title = $model->name;
$this->params['breadcrumbs'][] = ['label' => 'Affiliate Customer Contacts', 'url' => ['index']];
                        ...
                        <?= DetailView::widget([
                            ...
                            'attributes' => [
                                ...
                                [
                                    ...
                                    'value' => function ($model) {
                                        $user = new backend\modules\customer\models\AffiliateCustomerContact();
