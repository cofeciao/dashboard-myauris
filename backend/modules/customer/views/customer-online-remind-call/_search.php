...
if ($model->type_search_date == 'range') {
    $cls_col_1 = 'col-xxl-5 search-by-range';
                ...
                <div class="form-group form-content row ml-0 mr-0">
                    ...
                    <div class="f-content">
                        <div class="search-code">
                            <?= $form->field($model, 'full_name', ['template' => '<div class="input-group">{input}<span class="input-group-addon clear-value"><span class="fa fa-times"></span></span></div>'])->textInput(['placeholder' => "Họ và tên hoặc số điện thoại"])->label(false) ?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-search-col col-xl-4 col-sm-6 col-12 <?= $cls_col_1 ?>">
                <div class="form-group form-content row ml-0 mr-0">
                    <div class="f-title">
                ...
                <div class="form-group form-content row ml-0 mr-0">
                    ...
                    <div class="f-content">
                        <div class="search-type">
                            <?= $form->field($model, 'status_search', ['template' => '<div class="input-group">{input}<span class="input-group-addon clear-option"><span class="fa fa-times"></span></span></div>'])->dropDownList([
                                1 => 'Đặt hẹn không đến',
                                2 => 'Fail',
                                3 => 'KBM'
                            ], ['class' => 'form-control ui dropdown', 'prompt' => 'Chọn trạng thái'])->label(false) ?>
                        </div>
                    </div>
                </div>
            </div>
...
$('.f-title').on('click', 'input', function(){
    ...
    if(name == 'type-search-date'){
        if(v == 'range'){
            ...
            input.closest('.form-search-col').removeClass('col-xxl-5 col-xl-4 col-sm-6 col-12 search-by-range').addClass('ol-xxl-4 col-xl-4 col-sm-6 col-12');
        }
    }
});
