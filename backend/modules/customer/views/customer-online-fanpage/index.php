...
/* @var $searchModel backend\modules\customer\models\search\Dep365CustomerOnlineFanpageSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Trang facebook');
            ...
            <div class="card">
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <?php Pjax::begin(['id' => 'customer-online-fanpage', 'timeout' => false, 'enablePushState' => true, 'clientOptions' => ['method' => 'GET']]); ?>
...
//                                'filterModel' => $searchModel,
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\customer\models\Dep365CustomerOnlineFanpage();
...
customerOnline.init({
    pjaxId: '#customer-online-fanpage',
    urlChangePageSize: '$urlChangePageSize'
});

$('body').on('beforeSubmit', 'form#form-customer-fanpage', function(e){
    e.preventDefault();
   var currentUrl = $(location).attr('href');
   var formData = $('#form-customer-fanpage').serialize();
    
    $('#form-customer-fanpage').myLoading({opacity: true});
       
    $.ajax({
        url: $('#form-customer-fanpage').attr('action'),
        type: 'POST',
        data: formData,
        dataType: 'json',
    })
    .done(function(res) {
        $('#form-customer-fanpage').myUnloading();
        if (res.status == 200) {
