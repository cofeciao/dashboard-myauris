...
/* @var $searchModel backend\modules\customer\models\search\CustomerFeedbackSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Customer Feedbacks');
$this->params['breadcrumbs'][] = $this->title;

$user = new User();
$roleName = $user->getRoleName(Yii::$app->user->id);
$is_dev = Yii::$app->user->can(User::USER_DEVELOP);
?>
<section id="dom">
    <div class="row">
        <div class="col-12">
...
//                                'filterModel' => $searchModel,
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'header' => 'Actions',
                                        'visible' => $is_dev,
                                        'template' => '<div class="btn-group" role="group">{update}</div>',
                                        'buttons' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            ...
                                            if ($model->customerHasOne->full_name != null) {
                                                $name = $model->customerHasOne->full_name;
                                            } elseif ($model->customerHasOne->forename != null) {
                                                $name = $model->customerHasOne->forename;
                                            } else {
                                                $name = $model->customerHasOne->name;
                                            }
