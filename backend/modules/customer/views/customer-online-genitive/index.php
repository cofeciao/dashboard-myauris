...
/* @var $searchModel backend\modules\customer\models\search\Dep365CustomerOnlineGenitiveSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Nhóm tính cách');
...
<section id="dom">
    ...
    [
                        ...
                        <?php Pjax::begin(['id' => 'customerGenitive', 'timeout' => false, 'enablePushState' => false, 'clientOptions' => ['method' => 'GET']]); ?>
...
//                                'filterModel' => $searchModel,
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\customer\models\Dep365CustomerOnlineGenitive();
...
customerOnline.init({
    pjaxId: '#customerGenitive',
    urlChangePageSize: '$urlChangePageSize'
});

$('body').on('beforeSubmit', 'form#form-customer-genitive', function(e){
    e.preventDefault();
   var currentUrl = $(location).attr('href');
   var formData = $('#form-customer-genitive').serialize();
    
    $('#form-customer-genitive').myLoading({opacity: true});
       
    $.ajax({
        url: $('#form-customer-genitive').attr('action'),
        type: 'POST',
        data: formData,
        dataType: 'json',
    })
    .done(function(res) {
        $('#form-customer-genitive').myUnloading();
        if (res.status == 200) {
