...
/* @var $searchModel backend\modules\customer\models\search\Dep365CustomerOnlineNguonSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Nguồn khách hàng');
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            return Html::a($model->name, 'javascript:void(0)', [
                                                ...
                                                'data-keyboard' => false,
                                                'data-target' => '#custom-modal',
                                                'onclick' => 'showModal($(this), "' . \yii\helpers\Url::toRoute(['/customer/customer-online-nguon/view', 'id' => $model->id]) . '");return false;',
                                            ]);
                                        }
                                    ],
                                    [
                                        ...
                                        'value' => function ($model) {
                                            ...
                                            $name = Dep365Agency::getNameAgency($agency);
                                            return $name;
                                        },
                                    ],
                                    [
...
$(document).ready(function () {
    ...
    $('body').on('beforeSubmit', 'form#create-customer-online-nguon', function(e){
        e.preventDefault();
        var currentUrl = $(location).attr('href');
        var formData = $('#create-customer-online-nguon').serialize();
    
        $('#create-customer-online-nguon').myLoading({opacity: true});
        
        $.ajax({
            url: $('#create-customer-online-nguon').attr('action'),
            type: 'POST',
            dataType: 'json',
            data: formData,
        })
