...
/* @var $searchModel backend\modules\customer\models\search\Dep365CustomerOnlineDichVuSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Dịch vụ');
$this->params['breadcrumbs'][] = ['label' => Yii::t('backend', 'Customer'), 'url' => ['/customer']];
                                ...
                                <?= MyGridView::widget([
                                    ...
                                    'columns' => [
                                        ...
                                        [
                                            ...
                                            'value' => function ($model) {
                                                return Html::a($model->name, 'javascript:void(0)', [
                                                    ...
                                                    'data-keyboard' => false,
                                                    'data-target' => '#custom-modal',
                                                    'onclick' => 'showModal($(this), "' . \yii\helpers\Url::toRoute(['/customer/customer-online-dich-vu/view', 'id' => $model->id]) . '");return false;',
                                                ]);
                                            }
                                        ],
                                        [
                                        ...
                                        [
                                            ...
                                            'value' => function ($model) {
                                                $user = new backend\modules\customer\models\Dep365CustomerOnlineDichVu();
...
$('body').on('beforeSubmit', 'form#create-customer-online-dich-vu', function(e){
    e.preventDefault();
    var currentUrl = $(location).attr('href');
    var formData = $('#create-customer-online-dich-vu').serialize();

    $('#create-customer-online-dich-vu').myLoading({opacity: true});
    
    $.ajax({
        url: $('#create-customer-online-dich-vu').attr('action'),
        type: 'POST',
        dataType: 'json',
        data: formData,
    })
