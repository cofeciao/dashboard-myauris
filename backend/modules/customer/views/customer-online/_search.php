...
//$nickName = MyComponent::getCookies('nick-name') !== false ? MyComponent::getCookies('nick-name') : 1;
//$nameName = MyComponent::getCookies('name-name') !== false ? MyComponent::getCookies('name-name') : 1;
//$phoneNumber = MyComponent::getCookies('phone-number') !== false ? MyComponent::getCookies('phone-number') : 1;
//$tinhThanh = MyComponent::getCookies('tinh-thanh') !== false ? MyComponent::getCookies('tinh-thanh') : 1;
...
<?php $form = ActiveForm::begin([
    ...
    'options' => [
        'data-pjax' => 1,
        'id' => 'form-search-customer-online',
    ],
]); ?>
            ...
            <div class="form-search-col col-xl-7">
                ...
                <div class="row">
                    ...
                    <div class="form-search-col mult col-sm-6 col-12">
                        <div class="form-group form-content row ml-0 mr-0">
                            <div class="f-content">
                                <div class="search-code face_fanpage">
                                    <?php
                                    echo $form->field($model, 'face_fanpage', ['template' => '<div class="input-group">{input}<span class="input-group-addon clear-option"><span class="fa fa-times"></span></span></div>'])
                                        ->dropDownList(Dep365CustomerOnline::getFanpageFacebook(), ['id' => 'ui-drop', 'class' => 'ui dropdown form-control', 'prompt' => 'Page Facebook..'])
                                        ->label(false);
                                    ?>
                                </div>
                            </div>
...
$("#search-more").click(function(){
    ...
    customerOnline.setHeightContent();
});
...
$('#form-search-customer-online').on('mouseout mouseleave', 'input', function(){
    var v = $(this).val();
    v = v.trim();
    v = v.replace(/\s+/g, ' ');
    $(this).val(v.trim());
...
$('body').on('click', '#refresh-data', function(){
    $.pjax.reload({url: window.location.href, method: 'POST', container: customerOnline.options.pjaxId});
})
JS;
...
.face_fanpage .ui.dropdown .text{white-space:unset}
');
