...
use backend\modules\customer\models\search\Dep365AgencySearch;
...
/**
 * CustomerOnlineAgencyController implements the CRUD actions for Dep365Agency model.
 */
class CustomerOnlineAgencyController extends MyController
{
    ...
    {
        $searchModel = new Dep365AgencySearch();
    ...
    /**
     * Updates an existing Dep365Agency model.
    ...
    {
        if (($model = Dep365Agency::findOne($id)) !== null) {
            return $model;
        }
