...
use backend\modules\chi\models\search\DanhMucChiSearch;
...
/**
 * DanhMucChiController implements the CRUD actions for DanhMucChi model.
 */
class DanhMucChiController extends MyController
{
    public function beforeAction($action)
    {
        if (in_array($action->id, ['create', 'delete', 'update', 'show-hide'])) {
            $cache = Yii::$app->cache;
            $cache->delete('danh-muc-chi-get-danh-muc-chi');
        }
    ...
    {
        $searchModel = new DanhMucChiSearch();
    ...
    /**
     * Updates an existing DanhMucChi model.
    ...
    {
        if (($model = DanhMucChi::findOne($id)) !== null) {
            return $model;
        }
