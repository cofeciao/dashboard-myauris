...
/* @var $searchModel backend\modules\chi\models\search\DeadlineSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', Yii::t('backend', 'Deadlines'));
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\chi\models\Deadline();
                                            $userCreatedBy = $user->getUserCreatedBy($model->created_by);
                                            if (!empty($userCreatedBy)) {
