...
/* @var $searchModel backend\modules\chi\models\search\NhomChiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', Yii::t('backend', 'Nhom Chis'));
...
//                                'filterModel' => $searchModel,
                                ...
                                'columns' => [
                                    ...
                                    [
                                        'attribute' => 'category',
                                        'value' => function ($model) {
                                            if ($model->danhMucHasOne == null) {
                                                return null;
                                            }
                                            return $model->danhMucHasOne->name;
                                        }
                                    ],
                                    'code',
                                    [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\chi\models\NhomChi();
