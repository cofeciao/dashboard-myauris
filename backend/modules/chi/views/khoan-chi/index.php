...
/* @var $searchModel backend\modules\chi\models\search\KhoanChiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', Yii::t('backend', 'Khoan Chis'));
...
//                                'filterModel' => $searchModel,
                                ...
                                'columns' => [
                                    ...
                                    [
                                        'attribute' => 'category',
                                        'value' => function ($model) {
                                            if ($model->nhomChiHasOne == null) {
                                                return null;
                                            }
                                            return $model->nhomChiHasOne->name;
                                        }
                                    ],
                                    'code',
                                    [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\chi\models\KhoanChi();
