...
use backend\modules\cskh\models\LogCskhSearch;
...
/**
 * LogCskhController implements the CRUD actions for LogCskh model.
 */
class LogCskhController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new LogCskhSearch();
    ...
    /**
     * Updates an existing LogCskh model.
    ...
    {
        if (($model = LogCskh::findOne($id)) !== null) {
            return $model;
        }
