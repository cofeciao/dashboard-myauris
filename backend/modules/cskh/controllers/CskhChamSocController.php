...
namespace backend\modules\cskh\controllers;

use Yii;
use backend\modules\cskh\models\CskhChamSoc;
use backend\modules\cskh\models\CskhChamSocSearch;
...
/**
 * CskhChamSocController implements the CRUD actions for CskhChamSoc model.
 */
class CskhChamSocController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new CskhChamSocSearch();
    ...
    /**
     * Updates an existing CskhChamSoc model.
    ...
    {
        if (($model = CskhChamSoc::findOne($id)) !== null) {
            return $model;
        }
