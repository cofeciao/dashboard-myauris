...
use backend\modules\cskh\models\CskhQuanLySearch;
...
/**
 * CskhQuanLyController implements the CRUD actions for CskhQuanLy model.
 */
class CskhQuanLyController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new CskhQuanLySearch();
    ...
    /**
     * Updates an existing CskhQuanLy model.
    ...
    {
        if (($model = CskhQuanLy::findOne($id)) !== null) {
            return $model;
        }
