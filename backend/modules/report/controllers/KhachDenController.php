...
use backend\modules\report\components\KhachDen;
use backend\modules\setting\models\Dep365CoSo;
use common\models\User;
use yii\helpers\ArrayHelper;
use yii\web\Response;

class KhachDenController extends MyController
{
    ...
    {
        $data = KhachDen::getDataOnline($from, $to, $id_online, $id_location, $id_page, $id_coso);
        return $data;
    }
