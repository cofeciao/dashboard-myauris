...
use backend\modules\report\components\LichHen;
...
class LichHenController extends MyController
{
    ...
    {
        $data = LichHen::getDataOnline($from, $to, $id_online, $id_location, $id_page, $id_coso);
        return $data;
    }
