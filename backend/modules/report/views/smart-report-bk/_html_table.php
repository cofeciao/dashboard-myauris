        ...
        foreach ($data as $dm_id => $dm_chi) {
            ...
            foreach ($dm_chi['nhom_chi'] as $nhomchi_id => $nhom_chi) {
                ...
                <tr>
                    ...
                    <td class="text-center font-weight-bold"><?= round($nhom_chi['da_chi'] / $doanh_thu * 100, 2) . '%' ?></td>
                    <td class="text-right font-weight-bold">
                    ...
                    <td class="text-center font-weight-bold"><?= round($nhom_chi['sau_duyet'] / $doanh_thu * 100, 2) . '%' ?></td>
                </tr>
                <?php
                foreach ($nhom_chi['khoan_chi'] as $khoanchi_id => $khoan_chi) {
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= round($khoan_chi['da_chi'] / $doanh_thu * 100, 2) . '%' ?></td>
                        <td class="text-right">
                        ...
                        <td class="text-center"><?= round($khoan_chi['sau_duyet'] / $doanh_thu * 100, 2) . '%' ?></td>
                    </tr>
                    <?php
                }
                ?>
