...
$this->title = "Báo Cáo Sản Phẩm Phòng Khám";
?>
<section id="dom">
    <div class="row">
        <div class="col-12">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <?= Html::dropDownList(
                                        ...
                                        '',
                                        $listPhongKhamDichVu,
                                        ['class' => 'ui dropdown form-control', 'prompt' => 'Chọn phòng khám dịch vụ...', 'id' => 'id-phongkhamdichvu']
                                    ); ?>
                                    <span class="input-group-addon clear-option"><span
                                                class="fa fa-times"></span></span>
                                </div>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <?= Html::dropDownList(
                                        ...
                                        '',
                                        $listTrangThaiDV,
                                        ['class' => 'ui dropdown form-control', 'prompt' => 'Trạng thái DV...', 'id' => 'id-trangthaidichvu']
                                    ); ?>
                                    <span class="input-group-addon clear-option"><span
                                                class="fa fa-times"></span></span>
                                </div>
