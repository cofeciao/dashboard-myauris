                                            ...
                                            <div id="reportHeader-dateControl" class="report-header-datepicker"
                                                ...
                                                <div class="date-compare-selector"
                                                    ...
                                                    <select name="datecontrol-compare-selector"
                                                            class="ui dropdown form-control" disabled readonly
                                        ...
                                        <div class="col-8">
                                            <div id="overview-sparkline" style="margin:0 0 30px;text-align:left">
                                                ...
                                                <div class="sparkline-metric-analytics pageviews-group">
                                                    <div class="sparkline-metric-analytics.visits">Số lần xem trang
                                                    </div>
                                                    <div style="display:inline-block;margin:5px 0;text-align:left">
                                                        <div>76.716</div>
                                                        <div class="action-graph target-analytics.visits"></div>
                                                ...
                                                <div class="sparkline-metric-analytics avgPageviews-group">
                                                    <div class="sparkline-metric-analytics.visits">Số trang / phiên
                                                    </div>
                                                    <div style="display:inline-block;margin:5px 0;text-align:left">
                                                        <div>2,49</div>
                                                        <div class="action-graph target-analytics.visits"></div>
