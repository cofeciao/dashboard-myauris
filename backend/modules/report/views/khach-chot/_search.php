            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h4 class="card-title font-weight-bold text-right" id="tong-khach-chot"></h4>
                        </div>
                    </div>
                    <hr>
                                ...
                                <div class="input-group">
                                    <div class="input-group">
                                        <?= Html::dropDownList(
                                            ...
                                            '',
                                            $listCustomerCome,
                                            ['class' => 'ui dropdown form-control', 'prompt' => 'Chọn loại KH đồng ý...', 'id' => 'customer-come']
                                        ); ?>
                                        <span class="input-group-addon clear-option"><span class="fa fa-times"></span></span>
                                    </div>
                                </div>
