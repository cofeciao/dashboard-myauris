...
$('body').on('change', '.filter-data-from-online-report, #direct-sale, #id-location, #id-page, #customer-come, #id-coso', function() {
    callData();
});
...
function callData() {
   ...
   id_page = $("#id-page").val();
   cusomer_come = $("#customer-come").val();
   id_coso = $("#id-coso").val();
