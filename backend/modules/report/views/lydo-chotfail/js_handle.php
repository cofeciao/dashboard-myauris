...
$('body').on('change', '.filter-data-from-online-report, #direct-sale, #id-location, #reason-cancel, #id-page , #id-coso', function() {
    callData();
});
...
function callData() {
   ...
   reason_cancel = $('#reason-cancel').val();
   id_page = $("#id-page").val();
   id_coso = $("#id-coso").val();
   ...
   $.ajax({
       ...
       success: function (data) {
           $('#overview-graph-lineChart').myUnloading();
           $('#overview-graph-lineChart').css('border', 'none');
...
function buildTable(tableData){
    ...
    $("#tong-tu-choi").html("TỔNG : "+sum);
    $("#table-report-fail").html(html);
}
