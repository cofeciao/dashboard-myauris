...
/* @var $searchModel backend\modules\baocao\models\search\BaocaoLocationSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Khu vực');
$this->params['breadcrumbs'][] = ['label' => Yii::t('backend', 'Report'), 'url' => ['']];
$this->params['breadcrumbs'][] = $this->title;
?>
<?php Pjax::begin(['id' => 'location-face-ads-pjax', 'timeout' => false, 'enablePushState' => false, 'clientOptions' => ['method' => 'GET']]); ?>
<section id="dom">
    <div class="row">
        <div class="col-12">
            <?php
...
//                            'filterModel' => $searchModel,
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'value' => function ($model) {
                                        $user = new backend\modules\baocao\models\BaocaoLocation();
...
<?php
$url = \yii\helpers\Url::toRoute(['/baocao/baocao-location/show-hide']);
$urlDelete = \yii\helpers\Url::toRoute(['/baocao/baocao-location/delete']);
              ...
              $.ajax({
                ...
                success: function(data){
                    if(data.status == 'success') {
                        ...
                        $.pjax.reload({url: currentUrl, method: 'POST', container: '#location-face-ads-pjax'});
                    }
