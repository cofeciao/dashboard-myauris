...
/* @var $searchModel backend\modules\booking\models\search\UserRegisterSearch */
            ...
            <div class="card">
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <?php Pjax::begin(['id' => 'booking-user-register', 'timeout' => false, 'enablePushState' => true, 'clientOptions' => ['method' => 'GET']]); ?>
...
booking.init({
    pjaxId: '#booking-user-register',
    urlChangePageSize: '$urlChangePageSize'
});

$('body').on('beforeSubmit', 'form#form-user-register', function(e){
    e.preventDefault();
   var currentUrl = $(location).attr('href');
   var formData = $('#form-user-register').serialize();
    
    $('#form-user-register').myLoading({
        opacity: true
    });
    ...
    .done(function(res) {
        $('#form-user-register').myUnloading();
        if (res.status == 200) {
