...
/* @var $searchModel backend\modules\toothstatus\models\search\LuaChonSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Lua Chon');
                            ...
                            <?= MyGridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\toothstatus\models\LuaChon();
