...
/* @var $searchModel backend\modules\toothstatus\models\search\SearchTinhTrangRang */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Tình trạng răng');
...
//                                'filterModel' => $searchModel,
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return Html::img(\yii\helpers\Url::to('@web/uploads/rang/tinh-trang-rang/150x150/' . $model->image), ['height' => 100]);
                                        }
                                    ],
                                    'description:html',
                                    [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\toothstatus\models\TinhTrangRang();
...
<?php
$url = \yii\helpers\Url::toRoute(['/toothstatus/tinh-trang-rang/show-hide']);
$urlDelete = \yii\helpers\Url::toRoute(['/toothstatus/tinh-trang-rang/delete']);
$urlChangePageSize = \yii\helpers\Url::toRoute(['/toothstatus/tinh-trang-rang/perpage']);
