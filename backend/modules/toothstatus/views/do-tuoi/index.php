...
/* @var $searchModel backend\modules\toothstatus\models\search\DoTuoiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Do Tuois');
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            ...
                                            return Html::img(\yii\helpers\Url::to('@web/uploads/rang/do-tuoi/150x150/' . $model->image), ['height' => 100]);
                                        }
                                    ],
                                    [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\toothstatus\models\DoTuoi();
