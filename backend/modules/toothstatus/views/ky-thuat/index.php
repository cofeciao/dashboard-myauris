...
/* @var $searchModel backend\modules\toothstatus\models\search\SearchKyThuatRang */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Kỹ thuật');
...
//                                'filterModel' => $searchModel,
                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $user = new backend\modules\toothstatus\models\KyThuatRang();
...
<?php
$url = \yii\helpers\Url::toRoute(['/toothstatus/ky-thuat/show-hide']);
$urlDelete = \yii\helpers\Url::toRoute(['/toothstatus/ky-thuat/delete']);
$urlChangePageSize = \yii\helpers\Url::toRoute(['/toothstatus/ky-thuat/perpage']);
