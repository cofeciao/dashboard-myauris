...
use backend\modules\toothstatus\models\search\SearchKyThuatRang;
...
/**
 * KyThuatController implements the CRUD actions for KyThuatRang model.
 */
class KyThuatController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new SearchKyThuatRang();
    ...
    /**
     * Updates an existing KyThuatRang model.
    ...
    public function actionValidateForm($id = null)
    {
        if (Yii::$app->request->isAjax) {
            ...
            $model = new KyThuatRang();
            if ($id != null) {
                $model = KyThuatRang::find()->where(['id' => $id])->one();
            }
    ...
    {
        if (($model = KyThuatRang::findOne($id)) !== null) {
            return $model;
        }
