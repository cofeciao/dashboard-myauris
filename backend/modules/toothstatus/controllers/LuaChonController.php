...
use backend\modules\toothstatus\models\search\LuaChonSearch;
...
/**
 * LuaChonController implements the CRUD actions for LuaChon model.
 */
class LuaChonController extends MyController
{
    public function actionIndex()
    {
        $searchModel = new LuaChonSearch();
    ...
    /**
     * Updates an existing LuaChon model.
    ...
    {
        if (($model = LuaChon::find()->where([LuaChon::tableName().'.id' => $id])->one()) !== null) {
            return $model;
        }
